...
parser.add_argument("--save", help="File to save model", default='dgcnn.model')
...
parser.add_argument("--load_model", help="Name of previous trained model", default='dgcnn.model')
parser.add_argument("--num_clases", help="Total number of expected classes", default=11)
args = parser.parse_args()

device = 'cuda' if torch.cuda.is_available() else 'cpu'

model = DGCNN(k=3, output_channels=args.num_clases, emb_dims=args.d_model).to(device)
try:
